...
public class LoginManager implements HttpSessionBindingListener{
    ...
    public void valueBound(HttpSessionBindingEvent event) {
        ...
        System.out.println(event.getSession()+"세션"+ event.getName() + "세션 연결됨! ");
     ...
     public void valueUnbound(HttpSessionBindingEvent event) {
         ...
         System.out.println("  " + event.getSession() + "세션 끊김!");
     }
  ...
  /*   
      ...
      */
    /* public boolean isValid(MemberVO vo){
...
*/
    ...
    public boolean isUsing(String userID){
    	System.out.println("이미 사용중인 아이디~~~~~"+loginUsers.containsValue(userID));
    ...
    public void setSession(HttpSession session, String userId){
    	...
    	System.out.println("로그인 완료 아이디 세션에 저장~~~~~~"+session.getAttribute(userId));
    }
    ...
    public String getUserID(HttpSession session){
    	System.out.println("입력 받은 세션 Object 아이디 ~~~~"+(String)loginUsers.get(session));
    ...
    public void printloginUsers(){
        ...
        while(e.hasMoreElements()){
            session = (HttpSession)e.nextElement();
            System.out.println((++i) + ". 접속중인 모든 사용자 : " +  loginUsers.get(session));
        }
        System.out.println("===========================================");
     }
    ...
    public Collection getUsers(){
        ...
        System.out.println("현재 접속중!!!!!"+collection);
        return collection;
    }
}