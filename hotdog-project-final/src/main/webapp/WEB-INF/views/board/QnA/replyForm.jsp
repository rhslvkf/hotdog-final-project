...
<div class="col-sm-7">
    <h1>Q & A 답글</h1>
<div class="section">
		<form class="form-horizontal" role="form" action="${initParam.root}reply.do?type=board_QnA"
	...
	<div class="container">
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input type="text" class="form-control" id="boardTitle"  value="RE:${requestScope.bvo.boardTitle}"
