    ...
    $(document).ready(function(){
    	...
    	$("#resetBtn").click(function(){    		
    		if(confirm("글 작성을 취소하시겠습니까?")){
    			location.href = "getPostingList.do?type=board_abandoned";
    		}
    	});
    });	
</script>
 <br>
  <form action="${initParam.root}auth_posting.do?type=board_abandoned" method="post" id="write_form" enctype="multipart/form-data">
