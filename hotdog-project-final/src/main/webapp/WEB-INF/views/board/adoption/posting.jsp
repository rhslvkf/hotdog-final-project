...
<!-- 
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<textarea class="form-control" type="textarea" id="boardContent" name="boardContent"
			...
			<div class="form-group">
				<div class="col-sm-12">
					<label for="exampleInputFile">파일 업로드</label> <input type="file"
						name="file[0]" id="file0">
					<div id="fileInfo0"></div>
					<br> <input type="file" name="file[1]" id="file1">
					<div id="fileInfo1"></div>
					<br> <input type="file" name="file[2]" id="file2">
					<div id="fileInfo2"></div>
					<br>
					<div class="col-sm-12">
						<font color="red">* 이미지 파일만 업로드 가능합니다.<br> * 용량 제한은
							5MB입니다.
						</font>
					</div>
				</div>
