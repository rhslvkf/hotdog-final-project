...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
    ...
    $(document).ready(function(){
    	$("#listImg").click(function(){    		
    		location.href = "${initParam.root}getPostingList.do?type=board_notice";
    	});
    	$("#deleteImg").click(function(){ 
    		if(confirm("게시물을 삭제하시겠습니까?"))
    		location.href="auth_deletePosting.do?no=${requestScope.bvo.boardNumber }&type=board_notice";
    	});
    	$("#updateImg").click(function(){  
    		if(confirm("게시물을 수정하시겠습니까?"))
    		location.href="updateView.do?no=${requestScope.bvo.boardNumber}&type=board_notice";
    	});
    });	
</script>
<script type="text/javascript">
			...
			<td colspan="3"><pre style="white-space: pre-wrap;">${requestScope.bvo.boardContent}
                ...
                <div class="col-md-12 text-center">
                  <span class="pull-center">
                                    <a href="${initParam.root}getPostingList.do?type=board_notice" 
								 ...
								 <c:if test="${requestScope.bvo.memberVO.memberId==sessionScope.loginVo.memberId || sessionScope.loginVo.memberGrade=='ADMIN'}">
								    <a href="updateView.do?no=${requestScope.bvo.boardNumber}&type=board_notice" onclick="return confirm('수정하시겠습니까?')"
									class="btn btn-lg btn-warning"> 수정</a>
                					<a href="auth_deletePosting.do?no=${requestScope.bvo.boardNumber}&type=board_notice" onclick="return confirm('삭제하시겠습니까?')"
